...
type DocumentTableProps = {
  documents: Document[]
  isLoading?: boolean
  // You could add more props like onViewDocument, onMintDocument, etc.
}

export default function DocumentTable({ documents, isLoading = false }: DocumentTableProps) {
...
// Add debugging to DocumentTable
  console.log("DocumentTable received:", { documents, isLoading });
